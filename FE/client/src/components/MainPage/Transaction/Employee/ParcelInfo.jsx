        ...
        <div className="box">
          ...
          <div>
            ...
            <div className="code">
              ...
              <p>
                <b>Postal Code:</b> {props.formData.senderPostalCode}
              </p>
            </div>
          </div>
        </div>
        <div className="box">
          ...
          <div>
            ...
            <div className="code">
              ...
              <p>
                <b>Postal Code:</b> {props.formData.receiverPostalCode}
              </p>
            </div>
          </div>
        </div>
            ...
            <div className="check-box-group">
              <label className="checkBox">
                <input
                  type="checkbox"
                  className="input"
                  checked={props.formData.instruction == "Return immediately"}
                  disabled
                />
                <span className="custom-checkbox"></span>
                Return immediately
              ...
              <label className="checkBox">
                <input
                  type="checkbox"
                  className="input"
                  checked={props.formData.instruction == "Call sender/Transaction point"}
                  disabled
                />
                <span className="custom-checkbox"></span>
                Call the recipient
              ...
              <label className="checkBox">
                <input
                  type="checkbox"
                  className="input"
                  checked={props.formData.instruction == "Cancel order"}
                  disabled
                />
                <span className="custom-checkbox"></span>
                Cancel
            ...
            <div className="check-box-group">
              <label className="checkBox">
                <input
                  type="checkbox"
                  className="input"
                  checked={props.formData.instruction == "Return before date"}
                  disabled
                />
                <span className="custom-checkbox"></span>
              ...
              <label className="checkBox">
                <input
                  type="checkbox"
                  className="input"
                  checked={props.formData.instruction == "Return when storing time expired"}
                  disabled
                />
                <span className="custom-checkbox"></span>
